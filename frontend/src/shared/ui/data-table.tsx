      ...
      <div className="flex items-center justify-between px-4 lg:px-6">
        ...
        <Select
          ...
          items={[
            ...
            { label: "Прошлые результаты", value: "past-performance" },
            { label: "Ключевые люди", value: "key-personnel" },
            { label: "Важные документы", value: "focus-documents" },
          ]}
        >
          <SelectTrigger
          ...
          <SelectContent>
            <SelectGroup>
              ...
              <SelectItem value="focus-documents">Важные документы</SelectItem>
            </SelectGroup>
          </SelectContent>
        </Select>
        <TabsList className="hidden **:data-[slot=badge]:size-5 **:data-[slot=badge]:rounded-full **:data-[slot=badge]:bg-muted-foreground/30 **:data-[slot=badge]:px-1 @4xl/main:flex">
          ...
          <TabsTrigger value="key-personnel">
            Ключевые люди <Badge variant="secondary">2</Badge>
          </TabsTrigger>
          <TabsTrigger value="focus-documents">Важные документы</TabsTrigger>
        </TabsList>
        <div className="flex items-center gap-2">
          ...
          <Button variant="outline" size="sm">
            <PlusIcon
            />
            <span className="hidden lg:inline">Добавить секцию</span>
          </Button>
        </div>
      </div>
      <TabsContent
            ...
            <>
              ...
              <div className="grid gap-2">
                ...
                <div className="text-muted-foreground">
                  Динамика за последние 6 месяцев. Демонстрационный текст для
                  проверки вёрстки — несколько строк с переносами.
                </div>
              </div>
              <Separator />
            </>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="flex flex-col gap-3">
                ...
                <Select
                  ...
                  items={[
                    { label: "Оглавление", value: "Table of Contents" },
                    { label: "Резюме", value: "Executive Summary" },
                    {
                      label: "Технический подход",
                      value: "Technical Approach",
                    },
                    { label: "Дизайн", value: "Design" },
                    { label: "Компетенции", value: "Capabilities" },
                    { label: "Важные документы", value: "Focus Documents" },
                    { label: "Повествование", value: "Narrative" },
                    { label: "Титульная страница", value: "Cover Page" },
                  ]}
                >
                  ...
                  <SelectContent>
                    <SelectGroup>
                      ...
                      <SelectItem value="Capabilities">Компетенции</SelectItem>
                ...
                >
                  ...
                  <SelectContent>
                    <SelectGroup>
                      ...
                      <SelectItem value="In Process">В процессе</SelectItem>
