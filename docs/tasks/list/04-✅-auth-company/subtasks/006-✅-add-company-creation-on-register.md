...
**Сделано:** register создаёт company + membership owner в транзакции, slug collision handling.
...
| `docker compose exec mysql ... SELECT c.name,m.role FROM companies c JOIN company_memberships m ...` | owner role | см. Checks при поднятом MySQL |
