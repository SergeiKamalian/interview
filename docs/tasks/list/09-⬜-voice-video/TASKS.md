# 09 — Voice и video интервью Tasks
...
### TASK-09.1 — Разрешение доступа к микрофону
...
### TASK-09.3 — Endpoint загрузки аудио
...
### TASK-09.5 — Text-to-speech для вопросов
...
### TASK-09.6 — Хранение аудио-артефактов
...
### TASK-09.9 — Загрузка и хранение видео
...
### TASK-09.10 — Playback в отчете интервью
...
Блок `09-⬜-voice-video` считается completed только когда все subtasks `09.1`–`09.10` имеют status `[x] done`; папка переименована в `08-✅-voice-video`.
