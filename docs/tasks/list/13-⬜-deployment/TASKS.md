...
### TASK-13.2 — Production Docker для backend
...
### TASK-13.3 — Сборка и деплой frontend
...
### TASK-13.4 — MySQL production setup
...
### TASK-13.5 — Redis production setup
...
### TASK-13.6 — Настройка storage для audio/video
...
Блок `13-⬜-deployment` считается completed только когда все subtasks `13.1`–`13.9` имеют status `[x] done`; папка переименована в `13-✅-deployment`.
