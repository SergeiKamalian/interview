...
### TASK-11.1 — Конфигурация webhook для ATS
...
### TASK-11.3 — Экспорт результатов в JSON
...
### TASK-11.5 — Логи интеграционных отправок
...
### TASK-11.7 — Базовый API-адаптер ATS
...
Блок `11-⬜-ats-integrations` считается completed только когда все subtasks `11.1`–`11.7` имеют status `[x] done`; папка переименована в `11-✅-ats-integrations`.
