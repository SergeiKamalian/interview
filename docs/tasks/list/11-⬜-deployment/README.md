# 11-⬜-deployment — Deployment и эксплуатация
...
- Блок 09: наличие media pipeline, которому нужно object storage.
- Блок 10: интеграционные очереди/ретраи, требующие надёжного Redis и логов.
