# 11 — Deployment и эксплуатация Tasks
...
### TASK-11.1 — Документация production env
...
### TASK-11.2 — Production Docker для backend
...
### TASK-11.5 — Redis production setup
...
### TASK-11.6 — Настройка storage для audio/video
...
### TASK-11.7 — CI/CD заметки и pipeline
...
### TASK-11.9 — Стратегия резервного копирования
...
Блок `11-⬜-deployment` считается completed только когда все subtasks `11.1`–`11.9` имеют status `[x] done`; папка переименована в `10-✅-deployment`.
