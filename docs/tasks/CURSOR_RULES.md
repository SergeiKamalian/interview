...
Feature-блоки (`04-auth-company`, `05-question-bank`, `06-interview-core`, `07-ai-evaluation`, `09-voice-video` для media metadata, `10-ats-integrations` для integration logs) **зависят** от соответствующих design docs в `docs/database/schemas/`.
